...
public class FragmentGame extends Fragment implements View.OnClickListener{
    ...
    FragmentMakeWord fragmentMakeWord;
    Chronometer timerOfButton;
    @Override
    ...
    //*************************************************************
    public void setButtonInvisible(final ObjectAnimator buttonAnimation)
    {
    ...
    //*************************************************************
    public void setAnimationListener(ObjectAnimator animation)
    {
    ...
    //*************************************************************
    public void animateView(Button button)
    {
    ...
    //*************************************************************
    public void randomGenerateLetters()
    {
