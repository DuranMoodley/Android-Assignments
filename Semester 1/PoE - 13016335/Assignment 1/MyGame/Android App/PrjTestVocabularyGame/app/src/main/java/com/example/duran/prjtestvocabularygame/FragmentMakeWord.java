...
public class FragmentMakeWord extends Fragment implements View.OnClickListener{
    ...
    private EditText wordMaker;
    private Button addWord;
    private ListView wordList;
    private Chronometer wordMakerTimer;
    ...
    //**********************************************************************
    private void setTimerListener(View v)
    {
    ...
    //**********************************************************************
    private String [] setUrlWordSearch()
    {
    ...
    {
        public String getWordsValid( HttpURLConnection urlConnection)
        {
        ...
        protected String doInBackground(String... params)
        {
            ...
            DatabaseAdapter objDbAdapter = new DatabaseAdapter(getActivity());
            objDbAdapter.open();
            ...
            try
            {
                for (String param : params)
                {
                    ...
                    {
                        definitionOfWord = getWordsValid(urlConnection);

                        //If the word is valid and contains a definition
                        if (!definitionOfWord.isEmpty())
                        {
                            ...
                            if(objDbAdapter.getWord(arrWordAndUrl[1]).getCount() == 0)
                            {
                                objDbAdapter.insertWord(arrWordAndUrl[1], definitionOfWord);
                            }
                        }
                    }
                }
