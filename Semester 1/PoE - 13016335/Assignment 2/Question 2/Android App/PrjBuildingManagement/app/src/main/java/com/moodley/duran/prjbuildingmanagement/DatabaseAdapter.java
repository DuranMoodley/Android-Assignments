...
public class DatabaseAdapter {
    ...
    private static final String KEY_PROBLEM_RATING = "ProblemRating";
    ...
    private static final String DATABASE_CREATE_TENANTS =
            "create table tbl_tenants ( idNumber integer primary key, " +
    ...
    private static final String DATABASE_CREATE_INCIDENTS =
                        ...
                        "date text not null, " +
                        "time text not null," +
                        "ProblemRating text not null, foreign key (idTenant) references tbl_tenants (idNumber));";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
        {
            ...
            db.execSQL("DROP TABLE IF EXISTS tbl_tenants");
            onCreate(db);
        }
    }
    //End of Inner Class
    ...
    //***************************************************************
    public long insertIncident(String incidentName, String idNum , String date, String time , String problemRating)
    {
        ContentValues initialValues = new ContentValues();
        ...
        initialValues.put(KEY_PROBLEM_RATING,problemRating);
    ...
    public Cursor getAllIncidents()
    {
        ...
        return dbSQL.query(DATABASE_TABLE_INCIDENTS, new String[]{KEY_INCIDENT_NAME,
                        KEY_TENANT_ID,KEY_DATE,KEY_TIME,KEY_PROBLEM_RATING},
