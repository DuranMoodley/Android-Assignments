...
public class Student {
    ...
    //***********************************************************************************************
    public Student(String num,String modCode,String checkout, String dateCheckIn)
    {
        studNumber = num;
        moduleCode = modCode;
    ...
    //***********************************************************************************************
    public Student(String studNumber, String studName, String dateOfCheckin,  String moduleCode, String courseCode, String timeOfCheckOut)
    {
    ...
    //***********************************************************************************************
    public void setTimeOfCheckIn(String timeOfCheckIn) {
