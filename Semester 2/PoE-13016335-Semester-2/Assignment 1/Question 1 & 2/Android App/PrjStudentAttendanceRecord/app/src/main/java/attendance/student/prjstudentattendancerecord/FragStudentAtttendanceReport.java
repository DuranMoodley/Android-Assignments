...
public class FragStudentAtttendanceReport extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Retrieve student number from share preference and use it to gather attendance report of that student
        View view;
    ...
    private class RetrieveReportData extends AsyncTask<String,Void,ArrayList>
    {
        ...
        protected ArrayList doInBackground(String... params)
        {
            ...
            try {
                ...
                //Read each record and concatenate into a string,
                //The add into array list element
        ...
        {
            //Show arraylist results into the list view created
