...
public class StudentLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Cast widgets and retrieve share preferences value
        ...
        //Checking if student has logged in before, if the student has logged in
        // before the student number perference will have a value inside.
        //If checkin before, open the student main activity else prompt user to enter in details
    ...
    {
        SharedPreferences mygetprefs;
        mygetprefs = this.getSharedPreferences("myPreference",MODE_PRIVATE);
        ...
        {
            SharedPreferences.Editor editor = mygetprefs.edit();
